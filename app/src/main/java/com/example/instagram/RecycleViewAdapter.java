...
public class RecycleViewAdapter extends RecyclerView.Adapter<RecycleViewAdapter.ViewHolder>{
    ...
    private boolean[] liked = new boolean[10];
    private Context context;

    public RecycleViewAdapter(ArrayList<String> avatars, ArrayList<String> names, ArrayList<String> images, ArrayList<String> descriptions, ArrayList<String> views, Context context) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.parent_layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("liked", liked[position]);
